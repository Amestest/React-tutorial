...
const Game = () => {
    // 맞출 숫자를 입력하는 guess
        ...
        //<input type='number' value={guess} onChange={handleChange{(e) =>{setGuess(e.target.value)}} placeholder='1에서 10사이의 숫자 입력하기'/>
        ...
        const handleSubmit = (e) => {
            ...
            setAttempts(attempts + 1); // 맞추려고 작성한 숫자를 제출할 때 마다 제출시도횟수 1씩 증가
