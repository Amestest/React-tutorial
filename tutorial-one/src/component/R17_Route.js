/*
a태그로 href를 이;용할 경우 html 파일명을 작성해주는 것이기 때문에 React에서는 단순히 a태그와 href만 사용을 할 수 없음
...
* Router = 연결을 해주는데 연결 경로를 자동으로 전환해서 주는 기계
           ...
           고객(클라이언트 = 사용자)이 어떠한 특정 화면이나 기능을 보조가하여
...
2. router를 사용하기 위해 4가지 설정
   BorwserRouter : HTML 에서 URL 전체 관리자 역할 (Histroy API 사용 History = 기록)    
